...
class GDPRJudge:
    ...
    def analyze_gdpr_compliance(self, scenario: str, context: Dict = None) -> LegalAnalysis:
        ...
        try:
            ...
            prompt = self._create_legal_analysis_prompt(scenario, context)
            ...
            # Parse response
            analysis = self._parse_legal_response(response['response'], scenario)
    ...
    def _create_legal_analysis_prompt(self, scenario: str, context: Dict = None) -> str:
...
Be precise, cite specific articles, and avoid speculation. If uncertain, state limitations clearly."""
    ...
    def _parse_legal_response(self, response: str, scenario: str) -> LegalAnalysis:
    ...
    def _create_fallback_analysis(self, scenario: str) -> LegalAnalysis:
